    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Issues', 'Status'],
          ['Open',     <?php echo $open_issue_per; ?>],
          ['Close',      <?php echo $closed_issue_per; ?>],
          ['Not satisfied', <?php echo $notassinged_issue_per; ?>],
          ['Solved', <?php echo $solved_issue_per; ?>],
          ['Assinged',    <?php echo $assinged_issue_per; ?>],
          ['Varified close',   <?php echo $varifiedclosed_issue_per; ?>]
        ]);
