        ...
        <div class="container" style="margin-top: 50px;margin-bottom: 50px;">
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <select name="dpttype" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="dpt" class="form-control">
                       ...
                       <?php 
                       $qry_q="SELECT * FROM branch ORDER BY bid";
                       $result_q= mysqli_query($con, $qry_q);
                       while($row_q= mysqli_fetch_array($result_q)){
                           if($row_q["bname"]!='For all'){       
                               if($row_m["department"]==$row_q["bname"]){
                                   echo"<option value=".$row_q["bname"]." selected>".$row_q["bname"]."</option>";
                               }else{
                                    echo"<option value=".$row_q["bname"].">".$row_q["bname"]."</option>";
                               }
                           }
                       }
