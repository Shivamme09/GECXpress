    ...
    <body>
        ...
        <main class="hoc container clear"> 
          ...
          <div class="group center" style="">
              <?php if(isset($_REQUEST["delete"]) && isset($_REQUEST["delete"])=='yes'){ ?>
                <a href="News_view.php?delete=yes&&news_id=<?php echo$_REQUEST["news_id"]; ?>" onClick='return confirmDelete(this);' style="color:#000;text-decoration: none;" title="Delete the news">
              <?php }else{ ?>
          ...
          <!-- / main body -->
            ...
            <div class="text-center">
                <center>
                    <img src="<?php if($row["related_photo"]){
                        $ext = pathinfo($row["related_photo"],PATHINFO_EXTENSION);
                    if($ext=='pdf'){
                        ?>images/pdffile.png<?php
                    }else{
                        ?>
                         news/<?php echo $row["related_photo"];                          
                    }}
                    else{
                    ...
                    <div style="margin-top:20px;margin-left: 0px;">
                        ...
                        <a href='./news/<?php echo $row["related_photo"] ?>' target='_blank' class='btn btn-default'>See File / Photo</a>
                        <?php }else{ ?>
                        <a href='images/slider3.jpg' target='_blank' class='btn btn-default'>See File / Photo</a>
                        <?php } ?>
                    </div>
            ...
            <div class="form-group"><a style="text-decoration: none;" href="<?php echo $row["url"] ?>"><p style="color:#336699;font-size: 20px;"><?php echo $row["url"] ?></p></a></div>
