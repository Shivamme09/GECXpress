...
ini_set('display_errors', 0);
 ...
 if(isset($_REQUEST["btnlogin"]))
 {
     ...
     $sql="SELECT * FROM admin where admin_name='".$name."' and admin_pass='".$pass."'";
    ...
    <body style="background-color: #474747">
        ...
        <div class="container">
	        ...
	        <div class="form-group">
                    <button class="btn" type="submit" name="btnlogin" style="background-color: #38bec9;padding: 60px;border-radius: 4px;padding-right: 80px;padding-left: 80px;"><p style="color:#fff;font-size: 30px;">Login</p></button>
		</div>                         
               </div>
                </div>
               </div>
